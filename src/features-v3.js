...
function workspaceHTML() {
  ...
  <section data-v3-page="scene" class="v3-page active">
    ...
    <p>Continue usando a hierarquia, importação BLEND/FBX/GLB/OBJ, seleção múltipla e os objetos de cenário já existentes. O formato .blend é convertido localmente pelo Blender na versão Windows.</p>
    <div class="v3-grid two"><button data-v3-action="quality">Qualidade adaptativa</button><button data-v3-action="shortcuts">Atalhos e gestos</button><button data-v3-scene="hide">Ocultar selecionado (H)</button><button data-v3-scene="show-hidden">Mostrar ocultos (Alt+H)</button></div>
    <div id="v34-hidden-status" class="v3-controller-status">Nenhum objeto oculto.</div>
    <div class="v3-info"><strong>Visibilidade da cena</strong><span>Ocultar não apaga o objeto nem seus keyframes. Use H para ocultar a seleção e Alt+H para restaurar todos os objetos ocultos.</span></div>
  ...
  <section data-v3-page="model" class="v3-page">
    ...
    <div class="v3-grid three">
      ...
      <button data-v3-model="subdivide">Subdividir</button>
  ...
  <section data-v3-page="cad" class="v3-page">
    ...
    <div style="background:#0b0f19;border:1px solid #1e293b;border-radius:10px;padding:8px;margin-bottom:10px;">
      ...
      <div class="v3-segment" style="margin:0;">
        ...
        <button data-v3-cad-gizmo="scale">📐 Escalar (R)</button>
        <button data-v3-cad-gizmo="select">🎯 Selecionar</button>
      </div>
    </div>
      ...
      <div style="background:#0f172a;border:1px solid #1e293b;border-radius:10px;padding:10px;">
        ...
        <label class="v3-control">Plano Ativo do Esboço
          <select id="v3-cad-workplane">
            ...
            <option value="xy">Plano XY (Frente)</option>
            <option value="yz">Plano YZ (Lateral)</option>
        ...
        <div class="v3-segment">
          ...
          <button data-v3-cad-draw="rect">▭ Retângulo</button>
          <button data-v3-cad-draw="circle">⭕ Círculo</button>
    ...
    <div class="v3-subpanel" data-cad-panel="constraints">
      <div style="background:#0f172a;border:1px solid #1e293b;border-radius:10px;padding:10px;">
        ...
        <div class="v3-grid two" style="margin-top:8px;">
          ...
          <button data-v3-constraint="tangent" style="min-height:32px;">⭕ Tangente</button>
      ...
      <div style="background:#0f172a;border:1px solid #1e293b;border-radius:10px;padding:10px;">
        ...
        <label class="v3-control">Perfil do Tubo Estrutural
          <select id="v3-cad-pipe-type">
            ...
            <option value="round_32" selected>Tubo Redondo 32mm × 2.0mm (Chassi Kart / Gaiola)</option>
            <option value="square_30">Tubo Quadrado 30mm × 30mm (Perfis Metálicos)</option>
            <option value="square_40">Tubo Quadrado 40mm × 40mm (Estrutura Reforçada)</option>
          </select>
        </label>
        <div class="v3-grid two">
      ...
      <div style="background:#090d16;border:1px solid #10b981;border-radius:10px;padding:10px;">
        ...
        <label class="v3-control">Selecione o Estágio de Montagem
          <select id="v3-cad-buggy-stage">
            ...
            <option value="4">Estágio 4: Cobertura Traseira & Coxins (Engine Cover & Silent Blocks)</option>
            <option value="5">Estágio 5: Travessas de Ajuste do Motor (Engine Bay Bracing Stage 5)</option>
            <option value="6">Estágio 6: Conjunto Traseiro & Asa Aerodinâmica (Rear End & Wing Fitment)</option>
            <option value="7">Estágio 7: Estrutura Frontal do Bico (Nose Assembly 2126mm)</option>
            <option value="8">Estágio 8: Gaiola do Cockpit & Cabine (Front Rollbar Tube 440mm)</option>
            <option value="9">Estágio 9: Suporte da Alavanca de Câmbio (Gearshift Holder Assembly 90°)</option>
            <option value="10">Estágio 10: Tubulação da Suspensão Dianteira (Front Suspension Tubes 330mm)</option>
            <option value="11">Estágio 11: Tubulação da Suspensão Traseira (Rear Suspension Tubes 610mm)</option>
            <option value="12">Estágio 12: Suportes da Suspensão Traseira (Rear Suspension & Shock Plates)</option>
            <option value="13">Estágio 13: Suportes da Suspensão Dianteira (Front Suspension & Shock Plates)</option>
            <option value="14">Estágio 14: Fixação da Caixa de Direção (Steering Rack Mounting Plate S235)</option>
            <option value="15">Estágio 15: Suporte do Tanque & Asas (Fuel Tank & Rear Wing Brackets)</option>
            <option value="16">Estágio 16: Painel de Instrumentos & Capô (Dashboard S235 Folded 90°/38° & Hood)</option>
            <option value="17">Estágio 17: Tubos de Retenção do Bico (Nose Plating Protection Tubes Ø20)</option>
            <option value="18">Estágio 18: Tubos Diagonais de Reforço (Roll Cage Reinforcement & Silent Blocks)</option>
          </select>
        </label>
    ...
    <div class="v3-subpanel" data-cad-panel="tree">
      <div style="background:#0f172a;border:1px solid #1e293b;border-radius:10px;padding:10px;">
        ...
        <div class="v3-grid three">
          ...
          <label class="v3-control">Posição Z (m)<input id="v3-cad-pos-z" type="number" step="0.05" value="0.00"></label>
        </div>
        <div class="v3-grid three">
          <label class="v3-control">Rotação X (°)<input id="v3-cad-rot-x" type="number" step="5" value="0"></label>
          <label class="v3-control">Rotação Y (°)<input id="v3-cad-rot-y" type="number" step="5" value="0"></label>
          <label class="v3-control">Rotação Z (°)<input id="v3-cad-rot-z" type="number" step="5" value="0"></label>
        </div>
        <div class="v3-grid three">
          <label class="v3-control">Escala X<input id="v3-cad-scl-x" type="number" step="0.1" value="1.00"></label>
          <label class="v3-control">Escala Y<input id="v3-cad-scl-y" type="number" step="0.1" value="1.00"></label>
          <label class="v3-control">Escala Z<input id="v3-cad-scl-z" type="number" step="0.1" value="1.00"></label>
        </div>
        <div class="v3-grid three" style="margin-top:6px;">
          <button id="v3-cad-align-origin">🎯 Centralizar</button>
          <button id="v3-cad-align-floor">⬇️ Apoiar no Chão</button>
        ...
        <label class="v3-control">Material Mecânico
          <select id="v3-cad-material-preset">
            <option value="chrome">Aço Cromado Polido (Espelho)</option>
            <option value="steel" selected>Aço Carbono SAE 1020 / S355 (Fosco)</option>
            <option value="aluminum">Alumínio Escovado 6061-T6</option>
            <option value="titanium">Titânio Anodizado Azul</option>
            <option value="carbon">Fibra de Carbono Trama 3K</option>
            <option value="copper">Cobre / Latão Polido</option>
            <option value="acrylic">Acrílico Transparente / Polímero</option>
            <option value="paint_red">Tinta Automotiva Vermelho Corsa</option>
            <option value="paint_blue">Tinta Automotiva Azul Elétrico</option>
          </select>
        </label>
        <div class="v3-grid two">
          <label class="v3-control">Modo de Exibição
            <select id="v3-cad-display-mode">
              <option value="shaded">Sólido Sombreado</option>
              <option value="wireframe">Wireframe / Arestas</option>
              <option value="xray">Raio-X Transparente</option>
            </select>
          </label>
          <label class="v3-control">Opacidade (Raio-X)<input id="v3-cad-xray-slider" type="range" min="0.1" max="1.0" step="0.05" value="1.0"></label>
        </div>
      </div>
    </div>
      ...
      <div style="background:#0f172a;border:1px solid #1e293b;border-radius:10px;padding:10px;">
        ...
        <div id="v3-fea-results-card" style="margin-top:10px;display:none;border:1px solid #8b5cf6;border-radius:10px;padding:10px;background:#1e1b4b;">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;font-size:10px;color:#e0e0ff;">
            ...
            <div>Deflexão Máxima: <strong id="v3-fea-res-deflection" style="color:#facc15;">1.42 mm</strong></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section data-v3-page="animation" class="v3-page">
    ...
    <div class="v3-info"><strong>Uso no celular</strong><span>Ative IK, toque no alvo colorido e arraste. Em FK, selecione diretamente o osso e gire. Use Auto Key na timeline para registrar as mudanças.</span></div>
  </section>
...
function installWorkspaceUI(engine) {
  ...
  if (state.uiReady && existingBar && existingPanel) return;
  existingBar?.remove();
  ...
  bar.innerHTML = `
    ...
    <button data-v3-workspace="cad">CAD</button>
    <button data-v3-workspace="validation">Validação</button>
  ...
  bar.dataset.pageCount = '11';
  document.body.append(bar);
  const panel = document.createElement('aside');
  panel.id = 'v3-workspace-panel';
  panel.className = 'v3-workspace-panel';
  ...
  state.panel = panel;
  const requiredWorkspacePages = ['scene','model','cad','validation','sculpt','animation','materials','camera','characters','editor','downloads'];
  ...
  panel.querySelectorAll('[data-v3-scene]').forEach(button => button.addEventListener('click', () => {
    try {
      if (button.dataset.v3Scene === 'hide') hideSelectedSceneObjects(engine);
      else if (button.dataset.v3Scene === 'show-hidden') showHiddenSceneObjects(engine);
    } catch (error) {
      toast(engine, error.message, true);
    }
  }));
  ...
  panel.querySelector('#v3-close-panel')?.addEventListener('click', () => panel.classList.remove('open'));
  state.uiReady = true;
  ...
  function setupCadFloatingConstraintsToolbar() {
    ...
    const updateVisibility = () => {
      ...
      toolbar.style.display = isCadActive ? 'flex' : 'none';
    };
...
function installCustomUIAndLegalHandlers(engine) {
  ...
  btnAcceptEnter?.addEventListener('click', () => {
    ...
    toast(engine, `⚖️ Termos aceitos! Bem-vindo ao MNAnimat3D Studio (Idade: ${age} anos, País: ${country}).`);
  });
  ...
  if (legalModal) {
    ...
    closeLegalBtn?.addEventListener('click', () => legalModal.classList.add('hidden'));
...
export function enhanceV3UI(engine) {
  ...
  toast(engine, `MNAnimat3D v${VERSION}: Onboarding LGPD/GDPR, controle de idade, desfazer/refazer CAD (Ctrl+Z/Y) e medidas 3D ativadas.`);
}
